...
const FeautredEvents2 = ({ feauturedevents }) => {
  return (
    <div>
      <div className="relative min-h-[600px] w-full max-w-full lg:max-w-[1500px] lg:mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row gap-8 items-center justify-center z-20 px-4">
