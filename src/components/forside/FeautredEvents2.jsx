...
const FeautredEvents2 = ({ feauturedevents }) => {
  return (
    <div className="relative flex flex-col md:flex-row gap-8 items-center justify-center min-h-[600px] w-full max-w-full lg:max-w-[1500px] lg:mx-auto">
      <img src="/assets/bg/slider_bg_overlay.png" alt="baggrunsbillede med blå farver" className="absolute w-full h-full object-cover" />
      {feauturedevents.map((event) => (
        <motion.div key={event.id} className="relative w-[350px] md:w-[400px]" initial="rest" whileHover="hover" animate="rest">
          <div className="relative overflow-hidden">
            <Image className="w-[350px] md:w-[400px]" src={`${process.env.NEXT_PUBLIC_API_URL}${event.asset.url}`} alt={event.asset.alt} width={400} height={300} />
            <motion.div
