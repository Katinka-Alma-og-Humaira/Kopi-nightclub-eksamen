...
const FeautredEvents2 = ({ feauturedevents }) => {
  return (
    <div className="relative flex flex-col md:flex-row gap-8 items-center justify-center min-h-[600px]">
      ...
      {feauturedevents.map((event) => (
        <motion.div key={event.id} className="relative w-[350px] md:w-[400px]" initial="rest" whileHover="hover" animate="rest">
          <div className="relative overflow-hidden">
            <Image className="w-[350px] md:w-[400px]" src={`${process.env.NEXT_PUBLIC_API_URL}${event.asset.url}`} alt={event.asset.alt} width={300} height={50} />
            <motion.div
