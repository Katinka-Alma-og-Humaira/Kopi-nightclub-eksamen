...
const BookTableData = async ({ searchParams }) => {
  ...
  const reservationsUrl = eventId ? `${process.env.NEXT_PUBLIC_API_URL}/reservations?eventId=${eventId}` : `${process.env.NEXT_PUBLIC_API_URL}/reservations`;
