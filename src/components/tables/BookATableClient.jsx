  ...
  return (
    <section className="max-w-4xl mx-auto px-4 py-16 text-[var(--color-neutrals-200)]">
      ...
      <div className="flex flex-col gap-12">
        <div className="">
          <Tables reservations={currentReservations} selectedTable={selectedTable} onSelectTable={setSelectedTable} />
        </div>
        <div className="">
          <BookATable events={events} selectedTable={selectedTable} selectedEventFromBookNow={selectedEventFromBookNow} onReservationSuccess={handleReservationSuccess} />
        </div>
      </div>
    </section>
  );
