...
const BurgerMenu = () => {
  return (
    <>
      ...
      {/* Navbar */}
      <div className="md:hidden sticky top-0 z-50 relative flex justify-between p-7 h-25 w-full border-[var(--color-pink)] border-t-2 border-b-2 bg-[var(--color-black)]">
