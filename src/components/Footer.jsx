...
const Footer = async () => {
  return (
    <footer className="relative lg:max-w-[1500px] max-h-[1000px] lg:mx-auto flex flex-col justify-center items-center gap-3 bg-[url('/assets/bg/footerbg.jpg')] bg-no-repeat mt-20 pt-20 pb-5">
