...
const NavBar = () => {
  ...
  return (
    <div className="hidden md:flex relative justify-center gap-10 lg:gap-70 p-4 lg:p-8 h-auto lg:h-25 w-full border-[var(--color-pink)] border-t-2 border-b-2 lg:max-w-[1500px] max-h-[1000px] lg:mx-auto">
