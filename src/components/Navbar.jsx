...
import { textSplitTargets } from "@/components/splitText";
    ...
    <div className="hidden md:flex relative flex justify-center gap-70 p-8 h-25 w-full border-[var(--color-pink)] border-t-2 border-b-2">
      ...
      <nav className="flex items-center gap-10">
        <div className="flex flex-col items-center">
          <Link href="/" data-split className={pageNavn === "/" ? "text-[var(--color-pink)]" : "text-white"}>
            HOME
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/events" data-split className={pageNavn === "/events" ? "text-[var(--color-pink)]" : "text-white"}>
            EVENTS
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/book-table" data-split className={pageNavn === "/book-table" ? "text-[var(--color-pink)]" : "text-white"}>
            BOOK TABLE
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/contact" data-split className={pageNavn === "/contact" ? "text-[var(--color-pink)]" : "text-white"}>
            CONTACT US
          </Link>
