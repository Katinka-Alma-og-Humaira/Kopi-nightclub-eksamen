    ...
    <div className="hidden md:flex relative justify-center gap-10 lg:gap-70 p-4 lg:p-8 h-auto lg:h-25 w-full border-[var(--color-pink)] border-t-2 border-b-2">
      ...
      <nav className="flex items-center gap-4 lg:gap-10">
        <div className="flex flex-col items-center">
          <Link href="/" data-split {...(pageNavn === "/" ? { "data-active": true } : {})} className={`whitespace-nowrap ${pageNavn === "/" ? "text-[var(--color-pink)]" : "text-white"}`}>
            HOME
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/events" data-split {...(pageNavn === "/events" ? { "data-active": true } : {})} className={`whitespace-nowrap ${pageNavn === "/events" ? "text-[var(--color-pink)]" : "text-white"}`}>
            EVENTS
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/book-table" data-split {...(pageNavn === "/book-table" ? { "data-active": true } : {})} className={`whitespace-nowrap ${pageNavn === "/book-table" ? "text-[var(--color-pink)]" : "text-white"}`}>
            BOOK TABLE
          </Link>
        ...
        <div className="flex flex-col items-center">
          <Link href="/contact" data-split {...(pageNavn === "/contact" ? { "data-active": true } : {})} className={`whitespace-nowrap ${pageNavn === "/contact" ? "text-[var(--color-pink)]" : "text-white"}`}>
            CONTACT US
          </Link>
