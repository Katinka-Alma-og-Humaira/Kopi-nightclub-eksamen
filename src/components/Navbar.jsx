...
const NavBar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 hidden md:flex justify-center gap-10 lg:gap-70 p-4 lg:p-8 h-auto lg:h-25 w-full border-[var(--color-pink)] border-t-2 border-b-2 bg-[var(--color-black)] lg:max-w-[1500px] max-h-[1000px] lg:mx-auto">
